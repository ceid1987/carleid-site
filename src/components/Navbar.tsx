...
const Navbar: React.FC<NavbarProps> = ({ currentSection }) => {
  ...
  return (
    <nav className="fixed mt-14 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-black bg-opacity-10 backdrop-blur-lg rounded-full px-6 md:px-16 space-x-8 md:space-x-18 py-4 flex justify-center mx-auto z-50 ">
      {links.map(link => (
